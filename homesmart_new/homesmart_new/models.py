...
def create_homesmart_table(engine):
    """"""
    DeclarativeBase.metadata.create_all(engine)

class homesmart(DeclarativeBase):
    """
    ...
    agent_designation = Column("agent_designation",String, nullable=True)
    ...
    datacleaned_uuid = Column("datacleaned_uuid",String, nullable=True)
    uploading = Column("uploading",String, nullable=True)



    def __init__(self, agent_url, agent_dp,agent_name,agent_phone,agent_email,agent_role,agent_license,agent_areaserved,
                 agent_designation,agent_facebook,agent_instagram,agent_twitter,agent_linkedin,agent_pinterest,
                 ...
                 company_site,company_twitter,date_of_data_extraction,data_extracted_by,dataextraction_uuid,datacleaned_uuid,uploading):
        ...
        self.agent_designation =  agent_designation
        ...
        self.datacleaned_uuid = datacleaned_uuid
