...
#### Chromedriver Path and Headless options
    ...
    def __init__(self):
        ...
        self.driver = webdriver.Chrome(executable_path='D:/Tamil/chrome driver/chromedriver.exe',options=chrome_options)
...
#### Links Collection
    ...
    def parse(self,response):
        ...
        for next_button in range(0, 885):
            try:
        ...
        ## Output in txt file
        df = pd.DataFrame(list_of_hrefs,columns = ['links'])
        df.to_csv('agent_ca_links.csv',index=False)
